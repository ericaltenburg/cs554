<template>
    <div>
        <div v-if="!badLoad">
            <div v-if="!isLastPage">
                <router-link :to="{path:'/series/page/' + (pageNum+1)}">Next Page</router-link>
            </div>
            <br />
            <div v-if="pageNum !== 0">
                <router-link :to="{path:'/series/page/' + (pageNum-1)}">Previous Page</router-link>
            </div>
            <ul>
                <li v-for="(series_indiv,index) in series" :key="index">
